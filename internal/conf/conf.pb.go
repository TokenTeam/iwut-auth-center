...
type Service struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	App           *Service_App           `protobuf:"bytes,1,opt,name=app,proto3" json:"app,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *Service) GetApp() *Service_App {
	if x != nil {
		return x.App
	}
	return nil
...
func (x *Service_App) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
// Deprecated: Use Service_App.ProtoReflect.Descriptor instead.
func (*Service_App) Descriptor() ([]byte, []int) {
	return file_conf_conf_proto_rawDescGZIP(), []int{3, 0}
}

func (x *Service_App) GetUri() string {
	if x != nil {
		return x.Uri
	}
	return ""
...
const file_conf_conf_proto_rawDesc = "" +
	...
	"\x10oauth2_mem_limit\x18\x02 \x01(\x03R\x0eoauth2MemLimit\"M\n" +
	"\aService\x12)\n" +
	"\x03app\x18\x01 \x01(\v2\x17.kratos.api.Service.AppR\x03app\x1a\x17\n" +
	"\x03App\x12\x10\n" +
...
var file_conf_conf_proto_goTypes = []any{
	...
	(*Service_App)(nil),                   // 12: kratos.api.Service.App
...
var file_conf_conf_proto_depIdxs = []int32{
	...
	12, // 9: kratos.api.Service.app:type_name -> kratos.api.Service.App
	...
	10, // 14: kratos.api.Data.MongoDB.limitations:type_name -> kratos.api.Data.MongoDB.Limitations
	11, // 15: kratos.api.Data.MongoDB.Limitations.user:type_name -> kratos.api.Data.MongoDB.Limitations.User
